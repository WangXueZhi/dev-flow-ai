...
The report includes source documents, user stories, requirement constraints, acceptance criteria, detected stack, design asset details, artifact paths, applied patch summaries, backup manifests, verification status, visual checks, delivery readiness, open questions, and next actions.
...
- Delivery report generated from DevFlow artifacts, including acceptance criteria, delivery readiness, touched files, operation counts, backup counts, and line-count deltas when patch sets are applied.
