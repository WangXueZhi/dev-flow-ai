...
- Machine-readable delivery manifest for artifact status, readiness, verification, visual, source-change, API-state, screenshot, touched-file, backup, open-question, and delivery-risk summaries.
