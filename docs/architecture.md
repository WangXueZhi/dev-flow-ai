...
- Target Profile: derives normalized frontend target summaries plus stack-specific component, data, style, test, config, and verification candidates from the project brief and selected implementation unit, including Nuxt, Svelte/SvelteKit, Astro, and Angular-aware route, data, style, and test candidates.
