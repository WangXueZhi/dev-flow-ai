...
- Verification: runs recommended project commands and writes `.devflow/artifacts/verification-report.json`, including bounded stdout/stderr excerpts for failed commands.
