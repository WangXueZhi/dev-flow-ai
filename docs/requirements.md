...
- [ ] `dev-flow status` reads a delivery manifest and prints readiness, verification, visual, visual-layout, source-change, artifact, applied-operation, API-state, reviewer-note, verification-failure, remediation, risk, and open-question summaries.
