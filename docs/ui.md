...
- Missing required visual text: mark visual verification failed and surface the missing text in the visual report, delivery manifest, status output, and GitHub Actions summary.
